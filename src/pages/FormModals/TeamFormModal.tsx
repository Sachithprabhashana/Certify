...
type Props = {
    teamVisible: boolean;
    setTeamVisible: (value:boolean) => void
}
export const TeamFormModal:FC<Props> = ({teamVisible,setTeamVisible}) => {
    ...
    return(
    <div>
        <Modal title={'Add new team event'} open={teamVisible} footer={null} onCancel={handleCancel}>
            <Form
                name="basic"
                layout={'horizontal'}
                labelCol={{ span: 8 }}
